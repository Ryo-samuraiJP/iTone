...
// MusicPlayer component that displays the currently playing song, play/pause buttons, seek bar, etc.
const MusicPlayer = () => {
  const {
    track,
    seekBg,
    ...
    <div className="bottom-7 sm:bottom-0 left-0 right-0 z-50 h-[10%] bg-black flex justify-between items-center text-white pt-3 sm:pt-0 mb-5 sm:mb-0 px-4">
      <div className="hidden sm:flex items-center gap-4 w-1/5">
        <img
          className="w-12"
          src={track.image}
          alt="currently playing song image"
        />
      ...
      <div className="flex flex-col items-center m-auto">
        ...
        <div className="flex items-center gap-5">
          ...
          <div
            ref={seekBg}
            onClick={seekPoint}
            className="w-[60vw] max-w-[300px] bg-gray-500 rounded-full cursor-pointer"
          >
            <hr
              ref={seekBar}
              className="h-1 border-none w-0 bg-gray-200 rounded-full"
            />
          </div>
          <p>
