    ...
    <>
      ...
      <hr className='border-1 border-slate-700 mb-3'/>
      {
        songsByGenre.map((item, index) => (
          <div onClick={() => playWithId(item.id, albumData.name)} key={index} className='grid grid-cols-[2fr_2fr_0.5fr_0.35fr] sm:grid-cols-[2fr_2fr_0.5fr_0.35fr] gap-2 p-2 itemes-center text-[#a7a7a7] hover:bg-[#51505045] cursor-pointer'>
