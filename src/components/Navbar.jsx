    ...
    <>
      <div className='w-full flex justify-between items-center font-semibold'>
        <div className='flex items-center gap-2'>
          ...
          <div 
            onClick={() => navigate(-1)} 
            className='p-2 rounded-full cursor-pointer group bg-[#242424] hover:bg-[#3e3e3e] transition-all duration-300'
          >
          ...
          <div className='group'>
            <form className='form relative'>
              ...
              <input
                className='rounded-full px-10 py-1.5 border-2 border-transparent focus:outline-none bg-[#242424] hover:bg-[#3e3e3e] focus:border-blue-500 placeholder-gray-400 transition-all duration-300 cursor-pointer' 
                placeholder='Search...'
                type='text'
              />
        ...
        <div className='flex items-center gap-3'>
          <button className='cursor-pointer font-bold'>
            <p className='h-10 w-30 bg-[#242424] hover:bg-[#3e3e3e] text-gray-400 hover:text-white text-[15px] py-2 px-3 rounded-full transition-all duration-300'>Sign up</p>
          </button>
          <button className='cursor-pointer font-bold'>
      ...
      <div className='flex items-center gap-2 mt-4'>
        ...
        <button className='cursor-pointer font-medium'>
          <p className='bg-[#242424] hover:bg-[#3e3e3e] active:bg-white text-gray-400 hover:text-white active:text-black transition-all duration-300 px-4 py-1 rounded-full'>Music</p>
        </button>
        <button className='cursor-pointer font-medium'>
          <p className='bg-[#242424] hover:bg-[#3e3e3e] active:bg-white text-gray-400 hover:text-white active:text-black transition-all duration-300 px-4 py-1 rounded-full'>Podcasts</p>
        </button>
      </div>
    </>
  );
