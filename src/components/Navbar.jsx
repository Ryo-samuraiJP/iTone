...
// Navbar component that displays the Home and Arrow icons, and Search bar
const Navbar = () => {
    ...
    <>
      <div className="w-full flex justify-between items-center font-semibold">
        <div className="flex items-center gap-2">
          ...
          <div className="hidden sm:flex items-center gap-2">
            <button className="bg-[#242424] hover:bg-[#3e3e3e] w-10 h-10 rounded-full flex items-center justify-center group transition-all duration-300">
              <AiFillHome
                onClick={() => navigate("/")}
                className="text-2xl text-gray-400 group-hover:text-white transition-all duration-300 cursor-pointer"
              />
            </button>
          </div>
          <div
        ...
        <div className="flex items-center gap-3">
          <button className="cursor-pointer font-bold">
            <p className="h-10 w-30 bg-[#242424] hover:bg-[#3e3e3e] text-gray-400 hover:text-white text-[15px] py-2 px-3 rounded-full transition-all duration-300 hidden md:block">
              Sign up
            </p>
          </button>
          <button className="cursor-pointer font-bold">
            <p className="h-10 w-30 bg-white hover:bg-[#ffffffe6] text-black text-[15px] px-4 py-2 rounded-full transition-all duration-300 hidden md:block">
              Log in
            </p>
          </button>
          {/* <span>
      ...
      <div className="flex items-center gap-2 mt-4">
        <button className="cursor-pointer font-medium">
          <p className="bg-white hover:bg-[#ffffffe6] text-black px-4 py-1 rounded-full transition-all duration-300">
            All
          </p>
        </button>
        <button className="cursor-pointer font-medium">
          <p className="bg-[#242424] hover:bg-[#3e3e3e] text-gray-400 hover:text-white transition-all duration-300 px-4 py-1 rounded-full">
            Music
          </p>
        </button>
        <button className="cursor-pointer font-medium">
